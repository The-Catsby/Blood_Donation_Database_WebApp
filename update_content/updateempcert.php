...
$myquery= "UPDATE certified_as SET"
                            . " emp_id='" . $_POST["emp_id"] . "', "
                            . " cert_id='" . $_POST["cert_id"] . "', "
                            . " DateOfCert='" . $_POST["DateOfCert"] . "' "
                            . "WHERE emp_id=" . $_POST["emp_id_x"] . " AND cert_id=" . $_POST["cert_id_x"];
//echo $myquery;
...
if(!$stmt->execute()){
	...
	echo "Updated " . $stmt->affected_rows . " row from donors.";
}
$stmt->close();
?>
...
<head>
	<meta charset="utf-8">
	<title>Update Employee Certification</title>
</head>
<body>
