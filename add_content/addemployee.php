...
//	add POST data
if(!$stmt = $mysqli->prepare("INSERT INTO employees (clinic_id, fname, lname, sex) VALUES (?,?,?,?)")){
	echo "Prepare failed: " . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("isss", $_POST["clinic_id"], $_POST["fname"], $_POST["lname"], $_POST["sex"]))){
...
if(!$stmt->execute()){
	...
	echo "Added " . $stmt->affected_rows . " rows to employees.";
}
$stmt->close();
?>
